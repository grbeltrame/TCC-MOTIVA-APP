...
/// O widget principal de Resumo Semanal.
/// Carrega todos os dados via WeeklySummaryService e exibe na UI,
/// agora dentro de um Card que ocupa 98% da largura.
...
class _WeeklySummaryWidgetState extends State<WeeklySummaryWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // paleta de cores para cada estímulo (na ordem retornada pelo serviço)
    final stimuliColors = <Color>[
      AppColors.baseMagenta, // Força
      AppColors.baseBlue, // Cardio
      AppColors.darkBlue, // Mobilidade
    ];
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                                    ...
                                    Table(
                                      border: TableBorder(
                                        horizontalInside: BorderSide(
                                          color: AppColors.baseBlue.withOpacity(
                                            0.2,
                                          ),
                                        ),
                                      ),
                    ...
                    // --- Carga total levantada (seção isolada) ---
