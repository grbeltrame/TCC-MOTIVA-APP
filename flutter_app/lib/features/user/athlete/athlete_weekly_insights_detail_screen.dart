// lib/features/user/athlete/athlete_weekly_insights_detail_screen.dart
...
class AthleteWeeklyInsightsDetailScreen extends StatefulWidget {
  static const routeName = '/athlete_weekly_insights_detail';
  const AthleteWeeklyInsightsDetailScreen({Key? key}) : super(key: key);

  @override
  State<AthleteWeeklyInsightsDetailScreen> createState() =>
      _AthleteWeeklyInsightsDetailScreenState();
}

class _AthleteWeeklyInsightsDetailScreenState
    extends State<AthleteWeeklyInsightsDetailScreen> {
  late Future<AthleteWeeklyInsights?> _future;

  @override
  void initState() {
    super.initState();
    _future = AthleteInsightsService.fetchWeekly();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<AthleteWeeklyInsights?>(
        future: _future,
...
class _InsightTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final icon = isAlert ? Icons.warning_amber_rounded : Icons.lightbulb_outline;
